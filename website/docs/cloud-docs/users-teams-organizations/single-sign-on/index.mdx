...
1. If you've signed in to Terraform Cloud with SSO before, proceed to the next step.
   ...
   ![Screenshot: Terraform Cloud's create account page.](/img/docs/create-account.png)
    ...
    TODO: add new screen shot once PR is deployed https://github.com/hashicorp/atlas/pull/13220
   ![Screenshot: The password prompt for linking an SSO email address to a Terraform Cloud account.](/img/docs/ADD SCREENSHOT)
